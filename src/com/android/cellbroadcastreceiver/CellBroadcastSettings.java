...
public class CellBroadcastSettings extends PreferenceActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (MSimTelephonyManager.getDefault().isMultiSimEnabled()) {
            ...
            for (int i = 0; i < MSimTelephonyManager.getDefault().getPhoneCount(); i++) {
                actionBar.addTab(actionBar.newTab().setText(getMultiSimName(i)).setTabListener(
                        new MySubTabListener(new CellBroadcastSettingsFragment(), subTag[i])));
            }
        } else {
    ...
    private class MySubTabListener implements ActionBar.TabListener {
        ...
        public void onTabSelected(Tab tab, FragmentTransaction ft) {
            ...
            if (subTag[0].equals(tag)) {
                mSubscription = MSimConstants.SUB1;
            } else {
                mSubscription = MSimConstants.SUB2;
            }
    ...
    public class CellBroadcastSettingsFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            if (!res.getBoolean(R.bool.show_cmas_settings)) {
                ...
                alertCategory
                    .removePreference(findPreference(KEY_ENABLE_CMAS_EXTREME_THREAT_ALERTS));
                alertCategory
                    .removePreference(findPreference(KEY_ENABLE_CMAS_SEVERE_THREAT_ALERTS));
            ...
            if (enableSpeakerAlerts != null) {
                enableSpeakerAlerts.setOnPreferenceChangeListener(startConfigServiceListener);
            }
        }
    }
}
